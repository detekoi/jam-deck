...
OPTIONS = {
    'argv_emulation': True,
    'packages': ['jamdeck', 'ctypes', 'rumps'],  # Explicitly include required packages
    ...
    'plist': {
        ...
        'CFBundleVersion': '1.2.0', # CFBundleVersion: Internal build number
        'CFBundleShortVersionString': '1.2.0', # CFBundleShortVersionString: User-facing version number
